...
async function deploy() {
   ...
   //Deploy WETH
   const weth = await ethers.getContractFactory('WSAT');
   ...
   //Deploy Factory
   const factory = await ethers.getContractFactory('SubstationSwapV2Factory');
   ...
   const router = await ethers.getContractFactory('SubstationSwapRouter');
